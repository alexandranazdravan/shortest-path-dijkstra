/**
 *O clasa particulara de vehicule (motociclete), ce se incadreaza in
 *      in categoria mijlocealor de transport de gabarit mic, adica moped,
 *      si care implementeaza interfata generala de vehicule
 */
public class Motocicleta extends Moped implements Vehicul{
    /**
     * key = litera care imi spune pe ce caz sunt(aici m)
     */
    private String key;
    /**
     ...
     *      motocicleta cu toate caracteristicile sale
