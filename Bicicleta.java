/**
 *O clasa particulara de vehicule (biciclete), ce se incadreaza in
 *      in categoria mijlocealor de transport de gabarit mic, adica moped,
 *      si care implementeaza interfata generala de vehicule
 */
public class Bicicleta extends Moped implements Vehicul {
    /**
     * key = litera care imi spune pe ce caz sunt(aici b)
     */
    private String key;
    /**
     ...
     *      bicicleta cu toate caracteristicile sale
